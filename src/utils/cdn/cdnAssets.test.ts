...
describe("resolveBlogImage", () => {
  test("should resolve valid registered blog image path", () => {
    const resolved = resolveBlogImage(
      "/media/blog/images/windsurf_web_search_tutorial/docs_mentions.png",
    );
    expect(resolved).toContain(
      "/media/blog/images/windsurf-web-search-tutorial/docs-mentions.png",
    );
  });
  ...
  test("should handle special characters and sanitize correctly", () => {
    const resolved = resolveBlogImage(
      "/media/blog/images/YouTube Channel Artwork/Desktop Size.png",
    );
    expect(resolved).toContain(
  ...
  test("should return original path if not found in registered assets", () => {
    const unresolved = resolveBlogImage(
      "/media/blog/images/non_existent_image.png",
    );
