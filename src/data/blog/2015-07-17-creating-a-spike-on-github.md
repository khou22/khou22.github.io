...
![Github Spike](https://khou22.github.io/media/blog/images/Github%20Spike.jpg)

Here is a [useful article](http://nvie.com/posts/a-successful-git-branching-model/) about creating GitHub branches logically and neatly. It covers the importance of creating a good branch structure, especially when dealing with continuous development. Here is a cheat sheet: [http://nvie.com/files/Git-branching-model.pdf](http://nvie.com/files/Git-branching-model.pdf)
...
### Update July 4, 2017
Here's a good way of untracking files (especially those with sensitive information): `$ git update-index --assume-unchanged <file>`. This command simply stops tracking, it does not delete it so make sure there is no sensitive information before you add it to the repo. Use a placeholder like "API_KEY". To revert this, use `$ git update-index --no-assume-unchanged <file>`. To get a list of all files that are assumed-unchanged, use: `$ git ls-files -v|grep '^h'`.
