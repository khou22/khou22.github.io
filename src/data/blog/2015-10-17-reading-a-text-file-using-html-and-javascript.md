...
### Main Sources:
- [Mozilla Developer Network: FileReader.readAsText()](https://developer.mozilla.org/en-US/docs/Web/API/FileReader/readAsText)
- [Team Treehouse: Reading Files Using the HTML5 FileReader API](http://blog.teamtreehouse.com/reading-files-using-the-html5-filereader-api)
- [HTMLGoodies: Read Text Files Using the JavaScript FileReader](http://www.htmlgoodies.com/beyond/javascript/read-text-files-using-the-javascript-filereader.html#fbid=imWj_l2wfU6)
- [W3Schools: HTML Input Type Attribute](http://www.w3schools.com/tags/att_input_type.asp)
