...
I finally got around to designing my own YouTube channel artwork. Similar to a Facebook cover photo, YouTube's channel artwork is the second most important image to your YouTube brand. I had just released my first "high quality" [video](https://www.youtube.com/watch?v=_ZSztfYnnC8) and I wanted to improve the rest of my YouTube channel as well. Click [here](https://youtube.com/kevinhou22) to visit my YouTube channel.

### Design Process

I found a [template](http://2.bp.blogspot.com/-tjmufytBinc/UcvXPhPX8DI/AAAAAAAACYE/J8yVDWg25-I/s1600/YouTube-One-Channel-Template-Full-Optimized-(1).png) online that detailed the dimensions for each YouTube platform. For every YouTube client (ie. mobile, TV, computer, etc.), there is a specific cropping method. I used the dimensions to create a design that would look good on all possible devices.
