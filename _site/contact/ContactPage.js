      ...
      <div>
        <div className="contact-header">
          ...
          <h1 className="contact-header-title">
            Let's{" "}
            <div className="contact-header-title-fill-in">
              &#160;
              <span id="action-text" className="font-handwritten">
                create
              </span>
              &#160;
            </div>{" "}
        ...
        <div className="contact-centered">
          <div className="contact-tile">
            <img
              ...
              src="../media/site/icons/iphone_icon.png"
            />
            <br />
            iOS Development
          </div>
          <div className="contact-tile">
            <img
              className="contact-tile-icon"
              src="../media/site/icons/web_icon.png"
            />
            <br />
            Websites & Dynamic
            <br />
          ...
          <div className="contact-tile">
            <img
              className="contact-tile-icon"
              src="../media/site/icons/design_icon.png"
            />
            <br />
            UI/UX Design
          </div>
...
var ContactForm = React.createClass({
  ...
  submitForm: function (event) {
    ...
    if (validEntry) {
      $.post(
        "https://khou22.herokuapp.com/api/khou22/contact",
        ...
        function (data, status) {
          ...
          if (status == "success") {
            ...
            alert(
              "Email failed. If the problem persists, please contact me via LinkedIn."
            );
          }
        }
      );
    ...
    return (
      <form className="contact-form">
        <input
          ...
          className={`contact-form-email ${emailValidityClass}`}
          id="email"
